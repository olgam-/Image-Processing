...
[Hue1, Sat1, Int1] = rgbtohsi(Im1);
[Hue2, Sat2, Int2] = rgbtohsi(Im2);
[Hue3, Sat3, Int3] = rgbtohsi(Im3);

wavetype = 'db2';
[C1, P1] = wavedec2(Int1, 2, wavetype);
[C2, P2] = wavedec2(Int2, 2, wavetype);
[C3, P3] = wavedec2(Int3, 2, wavetype);
...
HSI = cat(3, Hue2, Sat2, I_new);
ImFinal = uint8(255 * hsitorgb(HSI));
